...
const Slider = () => {
    ...
    return (
        <div className="relative w-full h-screen overflow-hidden max-w-screen">
            <div className={`flex items-center w-full h-full transition-all slide slider`}>
                <div className="flex items-center flex-shrink-0 w-screen h-screen bg-gradient-to-br from-black to-slate-800">
                    <div className="flex flex-col text-white ml-4 md:ml-[200px] mt-30 gap-y-3 flex-shrink-0 w-full md:w-1/3">
                    ...
                    <div className="w-full h-full max-w-full">
                        <img src={`${hyper}`} className="w-full h-full select-none" alt="" />
                    </div>
                </div>
