...
const BillingHistoryPage = () => {
    ...
    useEffect(() => {
        fetch(`https://${process.env.REACT_APP_API_URL}/api/billing/`+localStorage.phoneNumber+"/"+billingStatus, {
            method: "GET",
            credentials: "include",
            headers: {
        ...
        <div className="mt-10 ml-10">
            <div className="flex">
                <div className="w-[300px] h-[500px] p-5 flex flex-col gap-8 border-r-2 border-gray-300">
                    ...
                    <div onClick={() => setBillingStatus(3)} className="flex gap-5 items-center hover:bg-gray-200 p-6">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
